...
export async function handleGetTokenSymbol(args: z.infer<typeof inputSchema>) {
  ...
  try {
    ...
    const contract = getErc20Contract(validated.tokenAddress, provider, ERC20_SYMBOL_ABI);
